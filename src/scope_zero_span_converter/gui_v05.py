...
from .dcm_parameter_extractor_widget_v3 import DcmParameterExtractorWidget
...
class MainWindow(WaveformResearchMainWindow):
    """v0.4 波形研究界面 + DCM SW 真值生成与逐阶段/全局参数反演。"""
    ...
    def __init__(self) -> None:
        ...
        LOGGER.info("DCM SW generator and staged/global parameter extractor tabs ready")
