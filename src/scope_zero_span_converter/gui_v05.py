...
from .dcm_parameter_extractor_widget_v2 import DcmParameterExtractorWidget
...
class MainWindow(WaveformResearchMainWindow):
    """v0.4 波形研究界面 + DCM SW 真值生成与逐阶段参数反演。"""
    ...
    def __init__(self) -> None:
        ...
        LOGGER.info("DCM SW generator and staged parameter extractor tabs ready")
