...
from .research_workspace import ResearchWorkspaceWindow
...
class MainWindow(ResearchWorkspaceWindow):
    """Five-workspace production UI with non-blocking conversion workers."""
