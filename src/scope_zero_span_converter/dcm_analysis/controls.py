...
class DcmAnalysisControls(QWidget):
    """Versionless DCM/Zero Span controls and synchronous state owner.

    The formal analysis widget supplies the production four-panel renderer and
    background scheduling through mixins. This class owns the common QWidget
    construction, parameter/profile state, debounce wiring, and the validated
    synchronous recompute/save fallbacks.
    """
