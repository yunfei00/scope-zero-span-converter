"""Presentation controls and marker overlays for the formal DCM analysis UI."""
...
class DcmAnalysisPresentationMixin:
    """Build information, peak, time-marker, and export controls."""
...
__all__ = ["DcmAnalysisPresentationMixin"]
